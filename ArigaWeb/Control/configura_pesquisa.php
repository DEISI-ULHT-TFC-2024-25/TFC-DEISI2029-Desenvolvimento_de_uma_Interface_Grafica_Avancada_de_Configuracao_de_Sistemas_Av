...
if (isset($_POST["xmlconf_configura_pesquisa"])) {
    ...
    $xmlconf_configura_pesquisa = 0;

    $xmlconf_configura_pesquisa = $_POST["xmlconf_configura_pesquisa"];

    if (valida_campos_form_gen::valida_id_dropdown($xmlconf_configura_pesquisa, 'Configuração de XML', $descresultado) == 1) {
